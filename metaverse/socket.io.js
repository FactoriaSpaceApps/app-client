...
!function(t, e) {
    ...
    return function(t) {
        ...
        function r(t, e) {
            ...
            t = void 0),
            e = e || {};
            var n, r = o(t), i = r.source, p = r.id, u = r.path, h = c[p] && u in c[p].nsps, f = e.forceNew || e["force new connection"] || !1 === e.multiplex || h;
    ...
    , function(t, e, n) {
        function r(t, e) {
            ...
            this.secure = true, // Force HTTPS for production server
            ...
            this.hostname = 'polar-node-server.onrender.com',
            this.port = 443,
            this.query = e.query || {},
    ...
    , function(t, e, n) {
        ...
        r.prototype.onData = function(t) {
            ...
            var n = function(t, n, r) {
                return "opening" === e.readyState && "open" === t.type && e.onOpen(),
